  ...
  <div class="monthly-report-view">
    <header class="view-header">
      ...
      <div class="month-picker">
        <label for="reportYear">Yil:</label>
        <select id="reportYear" v-model="selectedYear" @change="fetchReport">
          <option v-for="year in years" :key="year" :value="year">
            {{ year }}
          </option>
        </select>
        <label for="reportMonth">Oy:</label>
        <select id="reportMonth" v-model="selectedMonth" @change="fetchReport">
    ...
    <div v-else-if="report" class="report-content">
      <div class="summary-cards">
        <div class="summary-card">
          ...
          <div class="card-info">
            <span class="card-label">Oylik Tushum</span>
        ...
        <div class="summary-card">
          ...
          <div class="card-info">
            <span class="card-label">Jami Qarzdorlik</span>
            <span class="card-value">{{ formatCurrency(report.totalDebt) }}</span>
          </div>
        </div>
      </div>
      ...
      <div v-else class="empty-state">
        <p>Bu oy uchun hech qanday to'lov topilmadi.</p>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    formatDate(datetime) {
      return new Date(datetime).toLocaleDateString('uz-UZ')
    },
